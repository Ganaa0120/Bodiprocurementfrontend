...
> = {
  open: {
    ...
    icon: Globe,
    desc: "Бүх нийлүүлэгч харж, хариу өгч болно",
  },
  targeted: {
    label: "Хаалттай",
    color: "#a78bfa",
    ...
    icon: Lock,
    desc: "Сонгосон нийлүүлэгчдэд л харагдана",
  },
  rfq: {
    label: "Үнийн санал",
    color: "#f59e0b",
    ...
    icon: BarChart2,
    desc: "Тодорхой бараа/үйлчилгээний үнийн санал",
  },
};
