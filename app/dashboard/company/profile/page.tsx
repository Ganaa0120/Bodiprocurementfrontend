...
export default function CompanyProfilePage() {
  ...
  function AddDirectionRow({
    ...
    const available = dirs.filter(
      (d) => !selDirs.find((s) => Number(s.main_id) === Number(d.id)),
    );
    return (
                      ...
                      >
                        ...
                        >
                          {main.children.map((sub: any) => {
                            const isSubSel = sel.sub_ids.some(
            ...
            {[
              {
                value: "all",
                icon: "🔔",
                label: "Бүх үйл ажиллагааны чиглэлээр",
                desc: "Системд нийтлэгдсэн бүх зарын мэдэгдлийг хүлээн авна",
              },
              {
                value: "selected_dirs",
                icon: "🎯",
                label: "Зөвхөн сонгосон чиглэлээрээ",
              ...
              return (
                <div
                  ...
                  onMouseLeave={(e) =>
                    editing &&
                    ((e.currentTarget as HTMLElement).style.borderColor = isOn
                      ? "#6366f1"
                      : "#e2e8f0")
                  }
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    {/* ✅ selected_dirs сонгогдсон бол чиглэлүүдийг харуулна */}
