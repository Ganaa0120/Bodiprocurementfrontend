...
import { FInput, FSelect, RadioGroup } from "./FormFields";
...
function OwnerCard({
  ...
  const isFirst = idx === 0;
  // ✅ Эхний эзэмшигч: 5 field → tablet: 2+3 → mobile: 1
  // Дараагийн эзэмшигчид: 2 field → always 2 col
