        ...
        {editing && (
          <>
            ...
            <input
              ...
              style={{ display: "none" }}
              onChange={(e) =>
                e.target.files?.[0] && onFile("company_logo", e.target.files[0])
              }
            />
          </>
        )}
          ...
          >
            <span
              style={{
                ...
                flexShrink: 0,
                animation:
                  isNew || s === "pending" ? "pulse 1.5s infinite" : "none",
              }}
            />
            {badge.label}
          </span>
...
export function Alert({
  ...
  return (
    ...
    >
      <Icon
        size={14}
        style={{ color: isErr ? "#dc2626" : "#059669", flexShrink: 0 }}
      />
      <span
        style={{
          fontSize: 13,
          color: isErr ? "#dc2626" : "#059669",
          fontWeight: isErr ? 400 : 500,
        }}
      >
        {msg}
      </span>
