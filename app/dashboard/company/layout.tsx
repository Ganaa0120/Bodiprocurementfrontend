  ...
  return (
    ...
    `,
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  boxShadow: active
                    ? "0 10px 25px rgba(59,155,224,0.25)"
                    : "none",
                  overflow: "hidden",
                }}
              >
                ...
                {active && (
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        "linear-gradient(90deg, rgba(59,155,224,0.3), rgba(96,165,250,0.15))",
                      zIndex: -1,
                      borderRadius: 16,
                    }}
                  />
                ...
                {active && (
                  <div
                    style={{
                      ...
                      width: 5,
                      background:
                        "linear-gradient(to bottom, #60a5fa, #3b9be0)",
        ...
        <div
          style={{
            padding: "18px 20px",
            borderTop: "1px solid rgba(59,155,224,0.12)",
            zIndex: 3,
          }}
        >
          <button
      ...
      >
        ...
        <main
          className="company-main-area"
          style={{ flex: 1, padding: 24, overflowY: "auto", minWidth: 0 }}
        >
          {children}
        </main>
      </div>
