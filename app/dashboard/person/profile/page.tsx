...
// ✅ DirChips — олон чиглэл орвол хураах/дэлгэх
function DirChips({
  dirs,
  selDirs,
  editing,
  ...
  const LIMIT = 10;
  const visible = showAll ? dirs : dirs.slice(0, LIMIT);
  const hasMore = dirs.length > LIMIT;
  ...
  return (
    <>
            ...
            {visible.map((d) => {
              ...
              return (
                <button
                  key={d.id}
                  type="button"
                  onClick={() => editing && toggleMain(d.id)}
                  style={{
                    padding: "7px 16px",
                    borderRadius: 99,
                    fontSize: 12,
            ...
            {hasMore && (
              ...
              >
                {showAll ? (
                  ...
                  <>
                    <ChevronDown size={12} /> +{dirs.length - LIMIT} чиглэл
                    харах
                  </>
                )}
              </button>
      ...
      {/* ✅ Дэд чиглэл chips — сонгогдсон бүрд */}
      {selDirs.length > 0 && (
                  ...
                  {main.children.map((sub: any) => {
                    ...
                    return (
                      <button
                        key={sub.id}
                        type="button"
                        onClick={() => editing && toggleSub(main.id, sub.id)}
                        style={{
                          padding: "5px 12px",
                          borderRadius: 99,
                          fontSize: 12,
    ...
    >
      ...
      <Card>
        <SectionTitle
          ...
          subtitle="Худалдан авалтын зарын мэдэгдэл хэрхэн хүлээн авах"
        />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {[
            ...
            },
            {
              ...
              desc: "Миний сонгосон чиглэлтэй холбоотой зарын мэдэгдлийг л хүлээн авна",
            },
          ].map((opt) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {/* ✅ Сонгосон чиглэлүүдийг preview-д харуулна */}
